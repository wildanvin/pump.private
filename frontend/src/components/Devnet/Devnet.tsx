...
import MyConfidentialERC20Sepolia from '../../../../hardhat/deployments/sepolia/MyConfidentialERC20.json';
//import MyConfidentialERC20Local from '../../../../hardhat/deployments/localhost/MyConfidentialERC20.json';
    ...
    const loadData = () => {
      try {
        ...
        if (!import.meta.env.MOCKED) {
          MyConfidentialERC20 = MyConfidentialERC20Sepolia;
          // await import(
          ...
          // } else {
          //   MyConfidentialERC20 = MyConfidentialERC20Local;
          //   // await import(
